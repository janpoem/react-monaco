...
export default {
  name: 'atomize',
  displayName: 'Atomize(Atom One Dark)',
  isDark: true,
  colors: {
    primary: '#4D78CC',
    secondary: '#4B5365A6',
  ...
  data: {
    ...
    colors: {
      ...
      'editor.findMatchBackground': '#314166',
      'editor.findMatchHighlightBackground': '#518FFF36',
      'editor.findMatchBorder': '#518FFF',
      ...
      'editorBracketHighlight.foreground2': '#B556BD',
      'editorBracketHighlight.foreground3': '#4082DD',
      'editorBracketHighlight.foreground4': '#739E61',
      'editorBracketHighlight.foreground5': '#BE5046',
      'editorBracketHighlight.foreground6': '#C6A753',
      'editorBracketHighlight.unexpectedBracket.foreground': '#FF6347',
      'editorBracketMatch.background': '#282C34',
      'editorBracketMatch.border': '#518FFF',
      ...
      'gitlens.trailingLineForegroundColor': '#5C6370',
      'input.background': '#1B1D23BF',
      'input.border': '#181A1F',
      'input.foreground': '#D7DAE0',
      'input.placeholderForeground': '#6B727E',
      ...
      'statusBar.debuggingBackground': '#FF634788',
      ...
      'textBlockQuote.background': '#3A3F4BA6',
    ...
    rules: [
      ...
      {
        foreground: '#56B6C2',
        token: 'keyword.operator.combinator',
      },
      {
        foreground: '#56B6C2',
        token: 'keyword.operator.pattern',
      },
      {
        foreground: '#56B6C2',
      ...
      {
        foreground: '#E5C07B',
        token: 'entity.name.scope-resolution.function.call.cpp',
      },
      {
        foreground: '#E5C07B',
      ...
      {
        foreground: '#C678DD',
        token: 'keyword.operator.logical.and.media.scss',
      },
      {
        foreground: '#C678DD',
        token: 'keyword.operator.logical.scss',
      },
      {
        foreground: '#D19A66',
      ...
      {
        foreground: '#98C379',
        token: 'support.type.map.key.scss',
      },
      {
        foreground: '#98C379',
      ...
      },
      {
        fontStyle: 'italic',
        foreground: '#5C6370',
        token: 'punctuation.whitespace.comment',
      },
      {
        foreground: '#E5C07B',
      ...
      {
        foreground: '#E5C07B',
        token: 'support.type.location.graphql',
      },
      {
        foreground: '#E5C07B',
        token: 'support.type.enum.graphql',
      },
      {
        foreground: '#E5C07B',
        token: 'entity.scalar.graphql',
      },
      {
        foreground: '#56B6C2',
        token: 'punctuation.or.graphql',
      },
      {
        foreground: '#56B6C2',
        token: 'keyword.operator.nulltype.graphql',
      },
      {
        foreground: '#56B6C2',
        token: 'punctuation.assignment.graphql',
      },
      {
        fontStyle: 'italic',
        foreground: '#D19A66',
      ...
      },
      {
        fontStyle: 'italic',
        foreground: '#D19A66',
        token: 'entity.other.attribute-name.namespace.xml',
      },
      {
        fontStyle: 'italic',
        foreground: '#D19A66',
      ...
      {
        foreground: '#E5C07B',
        token: 'support.constant.json.jsx',
      },
      {
        foreground: '#E5C07B',
      ...
      {
        foreground: '#E5C07B',
        token: 'support.constant.json.tsx',
      },
      {
        foreground: '#E5C07B',
      ...
      {
        foreground: '#E5C07B',
        token: 'support.constant.math.jsx',
      },
      {
        foreground: '#E5C07B',
        token: 'support.constant.math.ts',
      },
      {
        foreground: '#E5C07B',
        token: 'support.constant.math.tsx',
      },
      {
        foreground: '#51B4C3',
      ...
      {
        foreground: '#98C379',
        token: 'fenced_code.block.language.markdown',
      },
      {
        foreground: '#E06C75',
      ...
      {
        foreground: '#56B6C2',
        token: 'keyword.operator.unpacking.arguments.python',
      },
      {
        foreground: '#56B6C2',
      ...
      {
        foreground: '#56B6C2',
        token: 'keyword.operator.math.sql',
      },
      {
        foreground: '#56B6C2',
        token: 'keyword.operator.star.sql',
      },
      {
        foreground: '#E06C75',
      ...
      {
        foreground: '#56B6C2',
        token: 'keyword.control.flow.block-scalar.folded.yaml',
      },
      {
        foreground: '#56B6C2',
        token: 'keyword.control.flow.block-scalar.literal.yaml',
      },
      {
        foreground: '#56B6C2',
        token: 'storage.modifier.chomping-indicator.yaml',
      },
    ],
    encodedTokensColors: [],
  },
